...
Shop.destroy_all
Shop.create(name:"BRAKE MASTER CYLINDER", description:"Master brake cylinder is the central element of the braking system, which converts the force applied to the brake pedal into the hydraulic pressure throughout the system.",image:"https://www.placehold.it/200",stock:20 , price:349)
